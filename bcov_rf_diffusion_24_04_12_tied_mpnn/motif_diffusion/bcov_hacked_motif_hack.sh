...
script="${LOGOS_PATH%/}/bcov_rf_diffusion_24_04_12_tied_mpnn/run_inference.py"


#reduce these values to sample less
num_tries=10 

out_folder="diffusion_outputs/${base}_"

apptainer exec -B /storage/d1/users/ruizhi/softwares/RFdiffusion/weights -B $LOGOS_PATH --nv \
     ${LOGOS_PATH%/}/bcov_rf_diffusion_24_04_12_tied_mpnn/make_apptainer/SE3nv.sif python \
     ...
     inference.ckpt_path=/storage/d1/users/ruizhi/softwares/RFdiffusion/weights/Complex_base_ckpt.pt \
