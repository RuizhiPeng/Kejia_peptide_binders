...
def print_diffusion_job(pdb, contigA, contigB):
    print(f"{logos_path}bcov_rf_diffusion_24_04_12_tied_mpnn/motif_diffusion/bcov_hacked_motif_hack.sh {pdb} {contigA} {contigB} /net/databases/diffusion/models/hotspot_models/BFF_4.pt")
